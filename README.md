...
If you need to import uncompiled TypeScript code from a Node module, you can use the command line option `--skip-ignore` or then environment variable `TS_NODE_SKIP_IGNORE` to bypass this restriction.
